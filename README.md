...
<div align="center">
  <picture>
    ...
    <img src="./assets/leonard-build-log.svg" width="100%" alt="Leonard Sánchez: Ingeniería en Computación, productos web, automatización y herramientas para estudiantes" />
  </picture>
  <p><a href="https://leonardsf.dev/"><strong>Explorar proyectos y servicios → leonardsf.dev</strong></a></p>
  <p><sub><a href="https://github.com/LeonardSF?tab=repositories">Repositorios</a> &nbsp;·&nbsp; <a href="https://t.me/LeonardSF">Telegram</a></sub></p>
</div>
...
**Construyo con:** TypeScript, JavaScript, React y Next.js<br>
**Datos e integración:** Node.js, REST APIs, PostgreSQL y MySQL<br>
